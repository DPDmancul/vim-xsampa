" vim-xsampa - automatic X-SAMPA to IPA translation
" Copyright (C) 2018  KeyboardFire <andy@keyboardfire.com>
" Copyright (C) 2022  Davide Peressoni <davide.peressoni@tuta.io>
...
imap <script> <expr> <Plug>xsampa <SID>xsampa()
if !hasmapto('<Plug>xsampa', 'i')
    execute 'imap <unique> ' . g:xsampa_trigger . ' <Plug>xsampa'
endif
